      ...
      leading: FutureBuilder<List<AppImage>>(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Text('Hospedeiro: ${Intl.plural(widget.nestRevision.eggsHost ?? 0, one: 'ovo', other: 'ovos')}, ${Intl.plural(widget.nestRevision.nestlingsHost ?? 0, one: 'ninhego', other: 'ninhegos')}'),
            Text('Nidoparasita: ${Intl.plural(widget.nestRevision.eggsParasite ?? 0, one: 'ovo', other: 'ovos')}, ${Intl.plural(widget.nestRevision.nestlingsParasite ?? 0, one: 'ninhego', other: 'ninhegos')}'),
          ],
        ),
