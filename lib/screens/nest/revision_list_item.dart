      ...
      leading: FutureBuilder<List<AppImage>>(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Text('Hospedeiro: ${Intl.plural(widget.nestRevision.eggsHost!, one: 'ovo', other: 'ovos')}, ${Intl.plural(widget.nestRevision.nestlingsHost!, one: 'ninhego', other: 'ninhegos')}'),
            Text('Nidoparasita: ${Intl.plural(widget.nestRevision.eggsParasite!, one: 'ovo', other: 'ovos')}, ${Intl.plural(widget.nestRevision.nestlingsParasite!, one: 'ninhego', other: 'ninhegos')}'),
          ],
        ),
